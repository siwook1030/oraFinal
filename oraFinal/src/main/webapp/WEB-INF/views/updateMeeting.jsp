	...
	<section>
		...
		<form action="updateMeeting" method="post" enctype="multipart/form-data">
			...
			코스 <select id="selectCourse" name="c_no">
					<option value="${mt.c_no }">${mt.c_no}.${mt.c_name }/${cs.c_loc }/${cs.c_view }</option>
			...
			<div id="selectLoc">
			<strong>원하는 위치를 클릭하여 미팅장소를 변경하세요!</strong><br><br>
			<!-- 위도 --> <input type="hidden" name="m_latitude" id="latitude" value="${mt.m_latitude }">
			<!-- 경도 --> <input type="hidden" name="m_longitude" id="longitude" value="${mt.m_longitude }">
			<input type="text" name="m_locname" id="addr" value="${mt.m_locname }" size="60" style="text-align: center">
	        </div>
			<br><br>
			<hr><br>
