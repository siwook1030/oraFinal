...
//
	...
	const btnUpdate = document.getElementById("n_btnUpdate");
      ...
      <div class="container">
        <div class="row justify-content-center mb-5" id="row">
          <div class="col-md-8 mx-md-5 ftco-animate">
			...
			<br>
			<a href="listNotice"><button type="button" class="btn btn-primary" id="n_btnList">목록</button></a>
			<div id="btnUD">
				<a href="/deleteNotice?n_no=${n.n_no }"><button type="button" class="btn btn-warning" id="n_btnDelete">삭제</button></a>
				<!-- <button type="button" id="btnUpdate" value="${n.n_no }">수정</button> -->
			 	<a href="/admin/updateNotice?n_no=${n.n_no}"><button type="button" class="btn btn-success" id="n_btnUpdate" value="${n.n_no }">수정</button></a> 
			</div>
          </div>
        </div> 
