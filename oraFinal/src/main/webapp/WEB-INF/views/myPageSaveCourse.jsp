    ...
    <section class="ftco-section ftco-no-pt">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
    		...
    		<div class="row">
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(/resources/images/place-1.jpg);">
							<div class="desc">
    			...
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(/resources/images/place-2.jpg);">
							<div class="desc">
    			...
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(/resources/images/place-3.jpg);">
							<div class="desc">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services services-2">
              <div class="media-body py-md-4 text-center">
              	...
              	<img src="/resources/images/blob.svg" alt=""></div>
